...
function SideBar() {
  ...
  return (
    <>
      <div className="w-screen h-16 bg-sky-600 flex justify-between items-center px-6 text-white">
        {close ? (
      ...
      <div className="absolute top-0 left-0 h-screen">
        ...
        >
          ...
          >
            ...
            <MenuItem component={<NavLink to="/schedule" />}>Schedule</MenuItem>
            ...
            <div className="mt-8 p-2 bg-gray-200">
              ...
              <div>
                ...
                <SubMenu label="Management" defaultOpen={false}>
                  ...
                  <MenuItem component={<NavLink to="/admin/notification" />}>
                    Notification
                  </MenuItem>
                </SubMenu>
              </div>
