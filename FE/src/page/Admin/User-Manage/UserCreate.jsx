...
const position = ["Employee", "Manager", "Admin"];
    ...
    <div className="mx-auto w-3/4">
      ...
      >
        <div className="grid grid-cols-2 gap-x-12 gap-y-6 px-24 ">
          ...
          <Input name="code" placeholder="User Code" type="text" />
          <Input name="password" placeholder="User Password" type="text" />
          <Input name="email" placeholder="User Email" type="email" />

          {/* selectors */}
          <Selector name="position" options={position} />
        </div>
        {/* submit and back */}
